...
public:
	...
	int getId() const;
	void insererChemin(std::pair<std::vector<Noeud*>, int>& tousLesChemins, std::vector<Noeud*>& previous, Noeud* but, int& distancePrecedente, Commande* commandeVoulue, Commande* commandeCollectee);
